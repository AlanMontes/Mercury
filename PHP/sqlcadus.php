...
$query = $mysqli->query("call lista_caducos('".$fi."', '".$ff."');");

echo "<div id='form'>";
echo "<table>";
echo "<tr><th>Lista de caducos</th></tr>";
echo "<tr>";
echo "<td>";
echo "<div id='form'>";
echo "<table id='productos'>";
echo "<tr><th id='td1'>ID/Código de Barras</th><th>Nombre</th><th>Caducos</th><th>Precio proveedor</th><th>Fecha registro</th><th id='td2'>Stock</th></tr>";
