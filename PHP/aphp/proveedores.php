       ...
       <center> <h1>Proveedores</h1>
        ...
        <a  href="pveditar.php" class="btn">Editar</a>
            ...
            <tr id="tpr">
                ...
                <th class="tb">Apellido Materno</th><th class="tb">Email</th><th class="tb">Teléfono</th><th class="tb">Empresa</th>
            </tr> <br></br>
            <?php
			...
			"</td><td>".$dat->correo."</td><td>".$dat->telefono."</td><td>".$dat->nombre_empresa."</td></tr>";
			}
            ?>
            </table></center>
        </section>
