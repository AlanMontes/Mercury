...
<nav class="navbar navbar-expand-lg">
    ...
    <div class="cont1">
        <div class="cont2">
    <section>
    <center><h1>Eliminar Proveedores</h1><br>
    ...
    <br></br>
        <table class="tpr">
            <tr>
                <th class="num">ID</th><th class="tb">Nombre</th><th class="tb">Apellido Paterno</th><th class="tb">Apellido Materno</th>
                <th class="tb">Telefono</th><th class="tb">Email</th><th class="tb">Empresa</th><th class="tb"></th>
            </tr>
           <?php
            //$id=$_GET['id'];
            ...
            <td><a id='eliminar'href='decision.php?id=".$dat->id_proveedor."'class='btn'>Eliminar</a></td></tr>";
            }
            ?>
