...
$query = $mysqli->query("SELECT id_producto,nombre_producto,precio_publico,precio_proveedor,cantidad_producto,cantidad_mermados,cantidad_caducos,
proveedor.nombre_empresa as 'proveedor' from producto
inner join proveedor on producto.id_proveedor = proveedor.id_proveedor  
where departamento = '".$tip."';");
